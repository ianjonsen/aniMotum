...
master branch:  
![example branch parameter](https://github.com/ianjonsen/foieGras/actions/workflows/check-full.yml/badge.svg?branch=master)

dev branch:  
![example branch parameter](https://github.com/ianjonsen/foieGras/actions/workflows/check-full.yaml/badge.svg?branch=dev)
<!-- badges: end -->
