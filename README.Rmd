...
```{r logo, echo=FALSE, message=FALSE, fig.align='center'}
...
`foieGras` is intended to be as easy to use as possible. Here's an example showing how to fit a move persistence model to Argos tracking data:
...
```{r explots1, echo=FALSE, message=FALSE, fig.dim=c(9,5), out.width="100%"}
plot(fit, type = 3, pages = 1, ncol = 2)
```
