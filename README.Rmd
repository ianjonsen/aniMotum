...
`foieGras` is intended to be as easy to use as possible. Here's an example showing how to quality-control Argos tracking data:
...
```{r explots1, echo=FALSE, message=FALSE, fig.dim=c(9,9), out.width="100%"}
plot(fit, pages = 1, ncol = 2)
```
