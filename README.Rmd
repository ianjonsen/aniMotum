...
master branch:  
[![Build Status](https://travis-ci.com/ianjonsen/foieGras.svg?branch=master)](https://travis-ci.com/ianjonsen/foieGras)  

dev branch:  
[![Build Status](https://travis-ci.com/ianjonsen/foieGras.svg?branch=dev)](https://travis-ci.com/ianjonsen/foieGras)
<!-- badges: end -->
