...
`foieGras` is intended to be as easy to use as possible. Here's an example showing how to quality control Argos tracking data and infer a behavioural index along animal tracks:
```{r example}
library(tidyverse)
library(foieGras)
