...
mp <- fmap(fssm, what = "predicted", crs = "+init=epsg:3031 +lon_0=85")
...
mp <- fmap(fssm, what = "predicted", obs = TRUE, crs="+init=epsg:3031 +lon_0=85", ext.rng=c(0.025, 0.075), size = 1.5)
