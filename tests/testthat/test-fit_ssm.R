...
##  tests expect that fit$ssm are 14-element lists (if optimiser does not crash)
...
test_that("fit_ssm defaults + crw + KF return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})

f <- fit_ssm(dls, model = "crw", time.step = 24)
test_that("fit_ssm defaults + crw + LS return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm defaults + rw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm vmax + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm vmax,ang + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm vmax,ang,min.dit + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm no spd filter + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm optim + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm full data + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm verbose + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm inner.control + crw return foieGras list w 14 elements", {
  expect_s3_class(f$ssm[[1]], "foieGras")
  expect_equal(length(f$ssm[[1]]), 14)
})
...
test_that("fit_ssm multi-track returns foieGras lists w 14 elements", {
