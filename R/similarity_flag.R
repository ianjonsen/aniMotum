...
##' observed path used in the SSM fit. In this context, similarity is the sum of 
##' normalised differences in distance and bearing between the SSM-estimated track
##' and the simulated tracks. Similarity flag values are based on two interpretations
