...
By default, `map()` will try to use `rnaturalearth::ne_countries(scale = 10)` land polygon data if the `rnaturalearthhires` data package is installed. If not, the default will be dropped to the coarser `scale=50`. The `rnaturalearthhires` package can be installed via: `install.packages("rnaturalearthhires", repos = "https://ropensci.r-universe.dev")`
