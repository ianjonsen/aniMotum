...
a behavioural index can be estimated from locations provided they occur regularly in time and they either have minimal location error (i.e. GPS data) or they have been SSM-filtered. We can fit the `mpm` to `foieGras` ssm-predicted locations. Here we use the SSM fits to the southern elephant seal data
